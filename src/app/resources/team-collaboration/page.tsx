...
import { Users, ArrowRight, Sparkles, Shield, KeyRound, ArrowRightLeft, MessageSquare } from "lucide-react";

const subpillars = [
  {
    title: "Team Features",
    description: "Discover powerful collaboration tools designed to help your sales team work together seamlessly and close more deals.",
    href: "/resources/team-collaboration/team-features",
    icon: Sparkles,
  },
  {
    title: "Role Management",
    description: "Set up and manage team roles to ensure the right people have access to the right information and capabilities.",
    href: "/resources/team-collaboration/role-management",
    icon: Shield,
  },
  {
    title: "User Permissions",
    description: "Configure granular user permissions to protect sensitive data while enabling productive workflows.",
    href: "/resources/team-collaboration/user-permissions",
    icon: KeyRound,
  },
  {
    title: "Lead Handoffs",
    description: "Master the art of seamless lead handoffs between team members to ensure no opportunity falls through the cracks.",
    href: "/resources/team-collaboration/lead-handoffs",
    icon: ArrowRightLeft,
  },
  {
    title: "Team Communication",
    description: "Improve internal communication with built-in tools that keep your team aligned and informed on every deal.",
    href: "/resources/team-collaboration/team-communication",
    icon: MessageSquare,
  },
];

export default function TeamCollaborationPillarPage() {
  return (
    <>
        ...
        <main>
          <section className="relative min-h-[50vh] flex items-center justify-center overflow-hidden pt-20">
            <div className="absolute inset-0 -z-10">
              ...
              <div className="absolute top-0 left-1/4 w-[500px] h-[500px] bg-teal-500/20 rounded-full blur-[128px] animate-pulse" />
            </div>
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
              ...
              >
                <div className="inline-flex items-center px-4 py-2 mb-6 text-sm font-medium rounded-full bg-teal-500/10 text-teal-400 border border-teal-500/20">
                  <Users className="w-4 h-4 mr-2" />
                  Team Collaboration Hub
                </div>

                <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold tracking-tight mb-6">
                  <GradientText animated>Team Collaboration</GradientText>
                </h1>

                <p className="text-lg sm:text-xl text-muted-foreground max-w-3xl mx-auto mb-8">
                  Empower your sales team to work together effectively with powerful collaboration tools, role management, and seamless communication features.
                </p>
              </motion.div>
            </div>
          </section>
