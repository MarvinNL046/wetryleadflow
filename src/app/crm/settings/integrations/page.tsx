    ...
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="mt-2 text-zinc-600 dark:text-zinc-400">
          Connect your external services to automatically import leads
        </p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <section className="max-w-2xl">
          ...
          {metaStatus.connected && (
            <Link
              href="/crm/settings/integrations/meta/forms"
        ...
        <section className="max-w-4xl">
          <div className="mb-6 flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-zinc-600 dark:text-zinc-400">
                Upcoming integrations we&apos;re working on
              </p>
            </div>
          </div>
          ...
          <div className="mt-6 rounded-lg border border-dashed border-zinc-300 bg-zinc-50/50 p-4 text-center dark:border-zinc-700 dark:bg-zinc-800/50">
            <p className="text-sm text-zinc-600 dark:text-zinc-400">
              ...
              <a
                href="mailto:support@leadflow.nl?subject=Integration%20Request"
