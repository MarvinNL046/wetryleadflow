...
CREATE INDEX IF NOT EXISTS product_workspace_idx ON products(workspace_id);
...
CREATE INDEX IF NOT EXISTS quotation_workspace_idx ON quotations(workspace_id);
CREATE INDEX IF NOT EXISTS quotation_contact_idx ON quotations(contact_id);
CREATE INDEX IF NOT EXISTS quotation_status_idx ON quotations(status);
...
CREATE INDEX IF NOT EXISTS invoice_workspace_idx ON invoices(workspace_id);
CREATE INDEX IF NOT EXISTS invoice_contact_idx ON invoices(contact_id);
...
CREATE INDEX IF NOT EXISTS line_item_quotation_idx ON line_items(quotation_id);
CREATE INDEX IF NOT EXISTS line_item_invoice_idx ON line_items(invoice_id);
...
CREATE INDEX IF NOT EXISTS invoice_settings_workspace_idx ON invoice_settings(workspace_id);
